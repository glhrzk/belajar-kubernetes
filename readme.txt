...
jika kita ingin mengatur di node mana pod akan dibuat dan dibgatasi maksimal pod yang akan di pasang (contoh 1 pod/aplikasi per node), kita bisa mengaturnya secara manual dengan daemon set.
 contoh kasus:
